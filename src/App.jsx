...
const ARMAS_CATALOGO = [
  ...
  { id: 'arm_tridente', nome: 'Tridente das profundezas', classe: 'sereia', subdivisaoId: 'triton',
    dano: '3d10', teste: 'Instrumento físico', peso: 4,
  ...
  { id: 'arm_lanca_coral', nome: 'Lança de coral', classe: 'sereia', subdivisaoId: 'triton',
    dano: '3d8', teste: 'Instrumento físico', peso: 3,
  ...
  { id: 'arm_sabre_pesado', nome: 'Sabre pesado', classe: 'pirata', subdivisaoId: 'predileto_mares',
    dano: '2d12', teste: 'Instrumento físico', peso: 4,
  ...
  { id: 'arm_ancora_mao', nome: 'Âncora de mão', classe: 'pirata', subdivisaoId: 'predileto_mares',
    dano: '1d20', teste: 'Instrumento físico', peso: 3,
  ...
  { id: 'arm_espada_cerimonial', nome: 'Espada cerimonial', classe: 'nascido_ouro', subdivisaoId: 'dono_coroa',
    dano: '2d12', teste: 'Autoridade', peso: 3,
...
const ITENS_CATALOGO = [
  ...
  { id: 'ite_batom_escamas', nome: 'Batom de escamas', classe: 'sereia', subdivisaoId: 'sereia', peso: 2,
    descricao: 'Enquanto usado, +3 em testes de Drama e Autoridade. Seu efeito dura 5 rodadas ou uma cena de interpretação inteira. Tem 3 usos.' },
...
const HABILIDADES_CATALOGO = [
  ...
  { id: 'hab_canto_afogamento', resistencia: 'Resiste com Volição.', nome: 'Canto do afogamento', classe: 'sereia', subdivisaoId: 'sereia',
    descricao: 'Todos que te ouvem resistem com Volição (DT da mestra) ou caminham na sua direção por 1 rodada, esquecendo o que estavam fazendo. Gasta 7 de sanidade.' },
  { id: 'hab_cancao_afogar', resistencia: 'Resiste com Resistência.', nome: 'Canção de Afogar', classe: 'sereia', subdivisaoId: 'sereia',
    descricao: 'O alvo sente água enchendo os pulmões, embora esteja em terra firme. 3d12, e ele perde a próxima ação tossindo. Gasta 8 de sanidade.' },
  ...
  { id: 'hab_voz_acalma', nome: 'A voz que acalma', classe: 'sereia', subdivisaoId: 'sereia',
    descricao: 'Você remove medo, pânico ou controle mental de um aliado. Gasta 9 de sanidade e pode ser usada uma vez por cena.' },
  ...
  { id: 'hab_mare_nao_recua', nome: 'A maré não recua', classe: 'sereia', subdivisaoId: 'triton',
    descricao: 'Enquanto estiver com menos da metade da vida, você recebe +5 em todos os testes de Físico. Gasta 8 de sanidade e o efeito dura até o final do combate.' },
  ...
  { id: 'hab_nao_foi_dessa_vez', nome: 'Não foi dessa vez', classe: 'pirata', subdivisaoId: 'predileto_mares',
    descricao: 'Quando sua vida chegaria a zero, você fica com 1 e continua de pé. Uma vez por sessão. Gasta 15 de sanidade.' },
  ...
  { id: 'hab_braco_esquerdo_ancore', nome: 'Braço esquerdo de Ancorê', classe: 'pirata', subdivisaoId: 'trapaceiro',
    descricao: 'Uma vez por cena, você declara que já esteve nesse lugar antes e conhece uma saída, um atalho ou um segredo dele. A mestra decide qual. Gasta 9 de sanidade.' },
  ...
  { id: 'hab_sou_um_de_voces', nome: 'Sou um de vocês', classe: 'nascido_ouro', subdivisaoId: 'bobo_corte',
    descricao: 'Um aliado recupera 3d10 de sanidade porque você conseguiu fazê-lo rir num momento impossível. Uma vez por cena. Gasta 12 da sua própria sanidade e requer roleplay.' },
...
const FEITICOS_CATALOGO = [
  ...
  { id: 'fei_forjador_mortifero', nome: 'Forjador Mortífero', nivelMin: 65,
    descricao: 'Você amaldiçoa a arma de um aliado seu à sua escolha para conceder 1d12 a mais de dano em todos os ataques com ela. Você gasta 5 de mana por arma amaldiçoada e a arma fica com sua marca desenhada nela com magia.',
    evolucoes: [
      'Você amaldiçoa a arma de um aliado seu à sua escolha para conceder 1d12 a mais de dano em todos os ataques com ela. Você gasta 5 de mana por arma amaldiçoada e a arma fica com sua marca desenhada nela com magia.',
  ...
  { id: 'fei_brincando_morcego', nome: 'Brincando de morcego', nivelMin: 80,
    ...
    evolucoes: [
      'Você fica de cabeça para baixo no ponto mais alto do recinto por 3 rodadas, atacando de cima e recuperando metade do dano causado em vida. Seus ataques são sombras indetectáveis (não podem ser esquivados) que causam 2d8 de dano. Gasta 5 de mana mas seu corpo não fica indetectável como seus ataques.',
      'Agora você está indetectável, mas não seus ataques. Alvos podem desviar com velocidade de reação, mas os ataques causam 2d12 de dano, e metade do dano causado volta para você em vida ou sanidade. Gasta 7 de mana.',
  ...
  { id: 'fei_tinta_fim', nome: 'Com essa tinta escrevo seu fim', nivelMin: 'negro',
    descricao: 'Você escreve o fim de alguém. O alvo sofre dano igual ao seu nível mágico inteiro + metade, sem resistência possível. Gasta 20 de mana, e você não pode conjurar nenhum outro feitiço nesta cena. Uma vez por sessão.' },
];
